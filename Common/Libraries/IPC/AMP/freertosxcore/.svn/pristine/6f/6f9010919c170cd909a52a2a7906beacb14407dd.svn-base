...
/* Support for default system parameters */
 ...
 * \ingroup SchedulerControl
 */
#define taskENTER_CRITICAL(pxMutex, xProcessor)		portENTER_CRITICAL(pxMutex, xProcessor)
 ...
 * \ingroup SchedulerControl
 */
#define taskEXIT_CRITICAL(pxMutex, xProcessor)			portEXIT_CRITICAL(pxMutex, xProcessor)
 ...
 * \ingroup Tasks
 */
#define xTaskCreate( processor, pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask ) xTaskGenericCreate( processor, ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( pxCreatedTask ), ( NULL ), ( NULL ) )
 ...
 * \ingroup TaskCtrl
 */
void vTaskDelay( xTaskHandle pxTaskToDelay, portTickType xTicksToDelay ) PRIVILEGED_FUNCTION;
 ...
 * \ingroup TaskCtrl
 */
void vTaskDelayUntil( xTaskHandle pxTaskToDelay, portTickType * const pxPreviousWakeTime, portTickType xTimeIncrement ) PRIVILEGED_FUNCTION;
...
unsigned portBASE_TYPE xGetTaskProcessor( void * task ) PRIVILEGED_FUNCTION;
 ...
 * period.
 */
void vTaskPlaceOnEventList( unsigned portBASE_TYPE processor, const xList * const pxEventList, portTickType xTicksToWait ) PRIVILEGED_FUNCTION;
 ...
 */
void vTaskPlaceOnEventListRestricted( unsigned portBASE_TYPE processor, const xList * const pxEventList, portTickType xTicksToWait ) PRIVILEGED_FUNCTION;
 ...
 * making the call, otherwise pdFALSE.
 */
signed portBASE_TYPE xTaskRemoveFromEventList( unsigned portBASE_TYPE processor, const xList * const pxEventList ) PRIVILEGED_FUNCTION;
 ...
 */
void vTaskSwitchContext() PRIVILEGED_FUNCTION;

/*
 * Return the handle of the calling task.
 */
xTaskHandle xTaskGetCurrentTaskHandle( unsigned portBASE_TYPE processor ) PRIVILEGED_FUNCTION;
 ...
 */
signed portBASE_TYPE xTaskGenericCreate( unsigned portBASE_TYPE processor, pdTASK_CODE pxTaskCode, const signed char * const pcName, unsigned short usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, xTaskHandle *pxCreatedTask, portSTACK_TYPE *puxStackBuffer, const xMemoryRegion * const xRegions ) PRIVILEGED_FUNCTION;

void * getTCBList();

void * pvGetMemoryMutexObject();

void vTaskAcquireNamedMutex( xTaskHandle currentTask, unsigned portBASE_TYPE mutexName ) PRIVILEGED_FUNCTION;

void vTaskReleaseNamedMutex( xTaskHandle currentTask, unsigned portBASE_TYPE mutexName ) PRIVILEGED_FUNCTION;

void vCPUAcquireMutex( unsigned portBASE_TYPE processor, void * mutex[2] ) PRIVILEGED_FUNCTION;

void vCPUReleaseMutex( unsigned portBASE_TYPE processor, void * mutex[2] ) PRIVILEGED_FUNCTION;

void safePrint(char * text) PRIVILEGED_FUNCTION;
